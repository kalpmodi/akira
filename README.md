...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=18&duration=2500&pause=800&color=BD93F9&center=true&vCenter=true&width=700&lines=Phase-chained.+Evidence-gated.+No+hallucinations.;Native+in+Claude+Code%2C+Gemini+CLI%2C+Cursor%2C+Codex;13+attack+modules.+Real+bug+bounty+proof.;plan-engagement+%E2%86%92+recon+%E2%86%92+secrets+%E2%86%92+exploit+%E2%86%92+report)](https://github.com/Kalp1774/akira)
...
| Skill | What It Does |
|---|---|
| `/403-bypass` | 29+ techniques: header tricks, parser confusion, BreakingWAF, Orange Tsai `?` ACL bypass (BH2024), CVE-2025-32094 OPTIONS smuggling, CVE-2026-34950 JWT, JSON body path traversal |
